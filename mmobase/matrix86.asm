...
internal_glhTranslatef2_SSE_Aligned proc matrix:DWORD, xyzw:DWORD
	mov		eax, matrix
	mov		ecx, xyzw
	...
	ret
internal_glhTranslatef2_SSE_Aligned endp

internal_glhScalef2_SSE_Aligned proc matrix:DWORD, xyzw:DWORD
	mov		eax, matrix
	mov		ecx, xyzw
	...
	movaps	[eax+32], xmm2
	ret
internal_glhScalef2_SSE_Aligned endp
