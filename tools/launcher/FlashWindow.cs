...
namespace launcher
{
    public static class FlashWindow
    {
        ...
        public static bool Flash(Form form)
        {
            ...
            if (Win2000OrLater)
            {
                var fi = Create_FLASHWINFO(form.Handle, FlashwAll | FlashwTimernofg, uint.MaxValue, 0);
        ...
        public static bool Flash(Form form, uint count)
        {
            if (Win2000OrLater)
            {
                var fi = Create_FLASHWINFO(form.Handle, FlashwAll, count, 0);
                return FlashWindowEx(ref fi);
            }
            return false;
        }
        ...
        public static bool Start(Form form)
        {
            if (Win2000OrLater)
            {
                var fi = Create_FLASHWINFO(form.Handle, FlashwAll, uint.MaxValue, 0);
                return FlashWindowEx(ref fi);
            }
            return false;
        }
        ...
        public static bool Stop(Form form)
        {
            if (Win2000OrLater)
            {
                var fi = Create_FLASHWINFO(form.Handle, FlashwStop, uint.MaxValue, 0);
                return FlashWindowEx(ref fi);
            }
            return false;
        }
